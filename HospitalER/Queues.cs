...
namespace HospitalER
{
    public class Screening
    {
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        public static int AddToScreening(Patient p)
        {
            if (!VerifyCC(p))
            {
                try
       ...
       /* /// <summary>
        ...
        public static void ListPatientsInScreening()
        {
            ...
            /*for (int i = 0; i < nPatients; i++)
            {
                ...
                Console.WriteLine("|{0,40}|{1,22}|{2,25}|{3, 67}|", queueScreening[i].Name, queueScreening[i].BirthDate, queueScreening[i].CC, queueScreening[i].Address);
                if (i + 1 < nPatients)
                    Console.WriteLine("|----------------------------------------|----------------------|-------------------------|-------------------------------------------------------------------|");
                else
                    Console.WriteLine("---------------------------------------------------------------------------------------------------------------------------------------------------------------");
